...
- (id)initWithMonth:(NSUInteger)month
{
    ...
    if (self)
    {
        _today = [[ITTDay alloc] initWithYear:[ITTDateUtil getCurrentYear] month:month day:1 hour:0 minute:0 second:0];
        [self caculateMonth];
    }
    return self;
}
...
- (id)initWithMonth:(NSUInteger)month year:(NSUInteger)year
{
    ...
    if (self)
    {
        _today = [[ITTDay alloc] initWithYear:year month:month day:1 hour:0 minute:0 second:0];
        [self caculateMonth];
    }
    return self;
}
...
- (id)initWithMonth:(NSUInteger)month year:(NSUInteger)year day:(NSUInteger)day
{
    ...
    if (self)
    {
        _today = [[ITTDay alloc] initWithYear:year month:month day:day hour:0 minute:0 second:0];
        [self caculateMonth];
    }
    return self;
}
...
- (void)caculateMonth
{
    ...
    {
        ITTDay *calDay = [[ITTDay alloc] initWithYear:_year month:_month day:day hour:0 minute:0 second:0];
