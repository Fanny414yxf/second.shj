...
{
    return [NSString stringWithFormat:@"year:%@ month:%@ day:%@ hour:%@ minute:%@ second:%@ week:%@ %@", @(_year), @(_month), @(_day), @(_hour), @(_minute), @(_second), @([self getMeaningfulWeekDay]), [self getWeekDayName]];
}
